                                                  ...
                                                  KeyListener
{
    ...
    */
    ...
    //REFACTORED
	private HImageButton createUploadButton() {
    ...
    //REFACTORED
	private HImageButton createZipButton() {
    ...
    //REFACTORED
	private HImageButton createCpButton() {
    ...
    private void createButtons() {
    	...
    	zipButton = createZipButton();
    	cpButton = createCpButton();
    ...
    //REFACTORED
    private void popUpMenuAddActionListeners() {
  ...
  //REFACTORED
    private void configureButtonPanel() {
    	FlowLayout f = createFlowLayout(FlowLayout.RIGHT);    	
    ...
    */
    public void gui_init()
    {
        ...
        popUpMenuAddActionListeners();//ADDED        
        ...
        JPanel second = createJPanel("East", uploadButton, p);//Moved code out            
        add("North", second);
        ...
        MouseListener mouseListener = createMouseListener();//Moved Code Out
        ...
        configureJsp(adjustmentListener, jsp);//ADDED
